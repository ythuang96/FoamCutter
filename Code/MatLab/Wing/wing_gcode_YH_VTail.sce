...
root_filename = 'fx76120.dat';       // airfoil section file for root
root_chord = 6.3;                   // root chord length [in]

tip_filename = 'fx76120.dat';        // airfoil section file for tip
tip_chord = 5.25;                    // tip chord length [in]
...
LE_sweep = 19.29004622;                    // leading edge sweep [deg]
twist = 0.0;                       // twist [deg]

g_filename = 'VTail.txt';         // g-code output file
